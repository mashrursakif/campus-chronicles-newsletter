	...
	return (
		<div className='overflow-visible w-auto md:w-[50vw] py-12 px-6 lg:px-10 flex flex-col'>
			<div className='max-w-4xl'>
				...
				<div className='mb-16'>
					<h3 className='text-3xl text-secondary mb-8'>Current Editors</h3>
					...
					<div className='flex flex-wrap gap-4'>
						<div className='bg-transparent border-1 border-amber-950 p-4 rounded-lg shadow-md min-w-[320px]'>
							...
							<p className='text-md text-gray-800'>AS Level, Class of 2026</p>
						</div>

						<div className='bg-transparent border-1 border-amber-950 p-4 rounded-lg shadow-md min-w-[320px]'>
							<h4 className='text-2xl text-primary mb-2'>Rakin Arabi Hasan</h4>
							<p className='text-md text-gray-800'>AS Level, Class of 2026</p>
						</div>
					</div>
				</div>
